---
page_title: "cloudflare_zero_trust_dlp_integration_entries Data Source - Cloudflare"
subcategory: ""
description: |-
...
# cloudflare_zero_trust_dlp_integration_entries (Data Source)
...
- `variant` (Attributes) A Predefined AI prompt classification topic entry. (see [below for nested schema](#nestedatt--result--variant))
- `word_list` (String)
