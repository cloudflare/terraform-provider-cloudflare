---
page_title: "cloudflare_oauth_clients Data Source - Cloudflare"
subcategory: ""
description: |-
...
# cloudflare_oauth_clients (Data Source)
...
- `client_uri_verification` (Attributes) Client URI domain control verification state. (see [below for nested schema](#nestedatt--result--client_uri_verification))
...
<a id="nestedatt--result--client_uri_verification"></a>
### Nested Schema for `result.client_uri_verification`
