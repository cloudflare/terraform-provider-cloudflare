---
page_title: "cloudflare_ai_search_instances Data Source - Cloudflare"
subcategory: ""
description: |-
  
---

# cloudflare_ai_search_instances (Data Source)
...
- `web_crawler` (Attributes) (see [below for nested schema](#nestedatt--result--source_params--web_crawler))

<a id="nestedatt--result--source_params--web_crawler"></a>
### Nested Schema for `result.source_params.web_crawler`
...
### Nested Schema for `result.source_params.web_crawler.store_options`
