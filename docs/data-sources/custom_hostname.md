...
- `dcv_delegation_records` (Attributes List) DCV Delegation records for domain validation. (see [below for nested schema](#nestedatt--ssl--dcv_delegation_records))
...
<a id="nestedatt--ssl--dcv_delegation_records"></a>
### Nested Schema for `ssl.dcv_delegation_records`
