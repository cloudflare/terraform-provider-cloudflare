...
- `pool_weights` (Attributes) A mapping of pool IDs to custom weights. The weight is relative to other pools in the load balancer. (see [below for nested schema](#nestedatt--result--random_steering--pool_weights))

<a id="nestedatt--result--random_steering--pool_weights"></a>
### Nested Schema for `result.random_steering.pool_weights`
...
### Nested Schema for `result.rules.overrides.ttl`
...
- `default_weight` (Number) The default weight for pools in the load balancer that are not specified in the pool_weights map.
- `pool_weights` (Attributes) A mapping of pool IDs to custom weights. The weight is relative to other pools in the load balancer. (see [below for nested schema](#nestedatt--result--rules--overrides--ttl--pool_weights))

<a id="nestedatt--result--rules--overrides--ttl--pool_weights"></a>
### Nested Schema for `result.rules.overrides.ttl.pool_weights`
