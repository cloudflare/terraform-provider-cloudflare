...
- `simple` (Attributes) The rate limit configuration. (see [below for nested schema](#nestedatt--result--bindings--simple))
...
- `params` (Attributes List) Pass information from the Dispatch Worker to the Outbound Worker through the parameters. (see [below for nested schema](#nestedatt--result--bindings--outbound--params))
- `worker` (Attributes) Outbound worker. (see [below for nested schema](#nestedatt--result--bindings--outbound--worker))

<a id="nestedatt--result--bindings--outbound--params"></a>
### Nested Schema for `result.bindings.outbound.params`
...
<a id="nestedatt--result--bindings--simple"></a>
### Nested Schema for `result.bindings.simple`
...
- `target` (Attributes List) Array of placement targets (currently limited to single target). (see [below for nested schema](#nestedatt--result--placement--target))

<a id="nestedatt--result--placement--target"></a>
### Nested Schema for `result.placement.target`
