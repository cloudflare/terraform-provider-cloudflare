...
- `email` (Attributes List) (see [below for nested schema](#nestedatt--result--consumers--settings--email))
...
- `pagerduty` (Attributes List) PagerDuty notification destinations. (see [below for nested schema](#nestedatt--result--consumers--settings--pagerduty))
...
- `webhooks` (Attributes List) Webhook notification destinations. (see [below for nested schema](#nestedatt--result--consumers--settings--webhooks))

<a id="nestedatt--result--consumers--settings--email"></a>
### Nested Schema for `result.consumers.settings.email`
...
<a id="nestedatt--result--consumers--settings--pagerduty"></a>
### Nested Schema for `result.consumers.settings.pagerduty`
...
<a id="nestedatt--result--consumers--settings--webhooks"></a>
### Nested Schema for `result.consumers.settings.webhooks`
