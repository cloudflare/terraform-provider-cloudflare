---
page_title: "cloudflare_ruleset_rules Data Source - Cloudflare"
subcategory: ""
description: |-
  This data source doesn't read data from Cloudflare's API. It can be used to construct rules in memory to pass between modules.
---

# cloudflare_ruleset_rules (Data Source)
...
- `id` (String) Internal identifier for the ruleset. This is not an ID of any actual Cloudflare resource and is only used for Terraform's state management. It is generated as a hash of the ruleset configuration and will change whenever the configuration changes.
