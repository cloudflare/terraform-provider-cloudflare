...
in the hierarchy.
- `managed_by` (String)
- `tenant_flags` (Attributes) Enable features for Organizations. (see [below for nested schema](#nestedatt--result--meta--tenant_flags))

<a id="nestedatt--result--meta--tenant_flags"></a>
### Nested Schema for `result.meta.tenant_flags`
