...
- `client_id` (String) Client ID associated with the Service Token (example: `5dcf7758214302822b912e452906149c.access`). **Modifying this attribute will force creation of a new resource.**
