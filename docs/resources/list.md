...
- `items` (Attributes Set) The items in the list. This overwrites all existing items in the list. Do not use with `cloudflare_list_item`. (see [below for nested schema](#nestedatt--items))
