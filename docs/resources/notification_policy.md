...
- `email` (Attributes Set) (see [below for nested schema](#nestedatt--mechanisms--email))
- `pagerduty` (Attributes Set) (see [below for nested schema](#nestedatt--mechanisms--pagerduty))
- `webhooks` (Attributes Set) (see [below for nested schema](#nestedatt--mechanisms--webhooks))
