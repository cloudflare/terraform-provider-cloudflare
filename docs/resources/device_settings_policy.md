...
- `service_mode_v2_mode` (String) The service mode. Defaults to `warp`. A service mode is any of the following values: `1dot1`, `warp`, `proxy`, `posture_only`, `warp_tunnel_only`
