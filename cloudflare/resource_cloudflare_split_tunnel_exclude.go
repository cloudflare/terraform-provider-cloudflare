...
func resourceCloudflareSplitTunnelExclude() *schema.Resource {
	return &schema.Resource{
		Read:   resourceCloudflareSplitTunnelsExcludeRead,
		Update: resourceCloudflareSplitTunnelsExcludeUpdate,
...
func resourceCloudflareSplitTunnelsExcludeRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*cloudflare.API)
	accountID := d.Get("account_id").(string)

  splitTunnel, err := client.SplitTunnelExclude(context.Background(), accountID)
	if err != nil {
...
func resourceCloudflareSplitTunnelsExcludeUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*cloudflare.API)
	accountID := d.Get("account_id").(string)

	// get all of the existing split tunnels
  existingSplitTunnel, err := client.SplitTunnelExclude(context.Background(), accountID)
	if err != nil {
		return fmt.Errorf("Error finding Include Split Tunnels %q", err)
	}
	...
	_, updateErr := client.UpdateSplitTunnelExclude(context.Background(), accountID, tunnelList)
	if updateErr != nil {
