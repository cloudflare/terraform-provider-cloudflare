...
package zero_trust_device_posture

import (
	"github.com/hashicorp/terraform-plugin-framework/types"
)

type ZeroTrustDevicePostureResultEnvelope struct {
	Result ZeroTrustDevicePostureModel `json:"result,computed"`
}

type ZeroTrustDevicePostureModel struct {
	...
	Input       *ZeroTrustDevicePostureInputModel    `tfsdk:"input" json:"input"`
	Match       *[]*ZeroTrustDevicePostureMatchModel `tfsdk:"match" json:"match"`
	Schedule    types.String                         `tfsdk:"schedule" json:"schedule"`
}

type ZeroTrustDevicePostureInputModel struct {
...
type ZeroTrustDevicePostureMatchModel struct {
