...
type AlertingPolicyResultEnvelope struct {
	Result AlertingPolicyModel `json:"result,computed"`
}

type AlertingPolicyModel struct {
	...
	Filters     *AlertingPolicyFiltersModel `tfsdk:"filters" json:"filters"`
}

type AlertingPolicyFiltersModel struct {
