...
var _ resource.Resource = &ZeroTrustAccessMutualTLSHostnameSettingsResource{}
var _ resource.ResourceWithImportState = &ZeroTrustAccessMutualTLSHostnameSettingsResource{}

func NewResource() resource.Resource {
	return &ZeroTrustAccessMutualTLSHostnameSettingsResource{}
}

type ZeroTrustAccessMutualTLSHostnameSettingsResource struct {
	client *muxclient.Client
}

func (r *ZeroTrustAccessMutualTLSHostnameSettingsResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zero_trust_access_mtls_hostname_settings"
}

func (r *ZeroTrustAccessMutualTLSHostnameSettingsResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ZeroTrustAccessMutualTLSHostnameSettingsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ZeroTrustAccessMutualTLSHostnameSettingsModel
...
func (r *ZeroTrustAccessMutualTLSHostnameSettingsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ZeroTrustAccessMutualTLSHostnameSettingsModel
...
func (r *ZeroTrustAccessMutualTLSHostnameSettingsResource) update(ctx context.Context, data *ZeroTrustAccessMutualTLSHostnameSettingsModel, identifier *cfv1.ResourceContainer) ([]cfv1.AccessMutualTLSHostnameSettings, error) {
...
func (r *ZeroTrustAccessMutualTLSHostnameSettingsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ZeroTrustAccessMutualTLSHostnameSettingsModel
...
func (r *ZeroTrustAccessMutualTLSHostnameSettingsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ZeroTrustAccessMutualTLSHostnameSettingsModel
...
func (r *ZeroTrustAccessMutualTLSHostnameSettingsResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
