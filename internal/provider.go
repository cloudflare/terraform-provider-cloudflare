...
import (
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/access_rule"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/account"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/account_member"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/account_role"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/account_subscription"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/api_shield"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/api_shield_schema_validation_settings"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/argo_smart_routing"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/argo_tiered_caching"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/byo_ip_prefix"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/certificate_pack"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/cloud_connector_rules"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/cloudforce_one_request"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/cloudforce_one_request_asset"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/cloudforce_one_request_message"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/cloudforce_one_request_priority"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/custom_ssl"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/d1_database"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/dcv_delegation"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/dns_firewall"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/email_routing_catch_all"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/image"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/image_variant"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/ip_ranges"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/list_item"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/load_balancer_pool"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/logpush_dataset_job"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/logpush_job"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/magic_wan_gre_tunnel"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/magic_wan_ipsec_tunnel"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/observatory_scheduled_test"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/origin_ca_certificate"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/page_shield_cookies"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/pages_project"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/permission_group"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/queue"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/r2_managed_domain"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/resource_group"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/stream_audio_track"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/stream_caption_language"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/stream_download"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/stream_key"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/tiered_cache"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/total_tls"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/turnstile_widget"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/user_agent_blocking_rule"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/waiting_room"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/waiting_room_event"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/waiting_room_rules"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/waiting_room_settings"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/workers_cron_trigger"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/workers_custom_domain"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/workers_deployment"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/workers_script_subdomain"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/workers_secret"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_access_application"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_access_mtls_hostname_settings"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_access_short_lived_certificate"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_access_tag"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_device_custom_profile"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_device_custom_profile_local_domain_fallback"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_device_default_profile"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_device_default_profile_certificates"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_dex_test"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_dlp_custom_profile"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_dlp_dataset"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_dlp_entry"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_dlp_predefined_profile"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_gateway_categories"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_gateway_certificate"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_gateway_policy"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_gateway_proxy_endpoint"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_risk_scoring_integration"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zero_trust_tunnel_cloudflared"
	...
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zone_lockdown"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zone_setting"
	"github.com/cloudflare/terraform-provider-cloudflare/v5/internal/services/zone_subscription"
