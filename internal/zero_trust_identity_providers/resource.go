...
var _ resource.Resource = &ZeroTrustIdentityProvidersResource{}

func NewResource() resource.Resource {
	return &ZeroTrustIdentityProvidersResource{}
}

// ZeroTrustIdentityProvidersResource defines the resource implementation.
type ZeroTrustIdentityProvidersResource struct {
	client *cloudflare.Client
}

func (r *ZeroTrustIdentityProvidersResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zero_trust_identity_providers"
}

func (r *ZeroTrustIdentityProvidersResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ZeroTrustIdentityProvidersResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ZeroTrustIdentityProvidersModel
	...
	_, err = r.client.ZeroTrust.IdentityProviders.New(
		ctx,
		zero_trust.IdentityProviderNewParamsAccessAzureAd{
...
func (r *ZeroTrustIdentityProvidersResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ZeroTrustIdentityProvidersModel
...
func (r *ZeroTrustIdentityProvidersResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ZeroTrustIdentityProvidersModel
...
func (r *ZeroTrustIdentityProvidersResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ZeroTrustIdentityProvidersModel
