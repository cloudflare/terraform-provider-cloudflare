...
var _ resource.Resource = &MagicTransitGRETunnelsResource{}

func NewResource() resource.Resource {
	return &MagicTransitGRETunnelsResource{}
}

// MagicTransitGRETunnelsResource defines the resource implementation.
type MagicTransitGRETunnelsResource struct {
	client *cloudflare.Client
}

func (r *MagicTransitGRETunnelsResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_magic_transit_gre_tunnels"
}

func (r *MagicTransitGRETunnelsResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *MagicTransitGRETunnelsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *MagicTransitGRETunnelsModel
	...
	env := MagicTransitGRETunnelsResultEnvelope{*data}
...
func (r *MagicTransitGRETunnelsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *MagicTransitGRETunnelsModel
...
func (r *MagicTransitGRETunnelsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *MagicTransitGRETunnelsModel
...
func (r *MagicTransitGRETunnelsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *MagicTransitGRETunnelsModel
