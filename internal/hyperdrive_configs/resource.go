...
var _ resource.Resource = &HyperdriveConfigsResource{}

func NewResource() resource.Resource {
	return &HyperdriveConfigsResource{}
}

// HyperdriveConfigsResource defines the resource implementation.
type HyperdriveConfigsResource struct {
	client *cloudflare.Client
}

func (r *HyperdriveConfigsResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_hyperdrive_configs"
}

func (r *HyperdriveConfigsResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *HyperdriveConfigsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *HyperdriveConfigsModel
	...
	env := HyperdriveConfigsResultEnvelope{*data}
...
func (r *HyperdriveConfigsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *HyperdriveConfigsModel
...
func (r *HyperdriveConfigsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *HyperdriveConfigsModel
...
func (r *HyperdriveConfigsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *HyperdriveConfigsModel
