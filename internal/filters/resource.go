...
var _ resource.Resource = &FiltersResource{}

func NewResource() resource.Resource {
	return &FiltersResource{}
}

// FiltersResource defines the resource implementation.
type FiltersResource struct {
	client *cloudflare.Client
}

func (r *FiltersResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_filters"
}

func (r *FiltersResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *FiltersResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	env := FiltersResultEnvelope{*data}
...
func (r *FiltersResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *FiltersModel
...
func (r *FiltersResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *FiltersModel
...
func (r *FiltersResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *FiltersModel
