...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustRiskScoreIntegrationsDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[ZeroTrustRiskScoreIntegrationsResultDataSourceModel](ctx),
...
func (d *ZeroTrustRiskScoreIntegrationsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *ZeroTrustRiskScoreIntegrationsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
