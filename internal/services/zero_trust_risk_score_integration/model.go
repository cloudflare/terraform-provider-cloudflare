...
type ZeroTrustRiskScoreIntegrationResultEnvelope struct {
	Result ZeroTrustRiskScoreIntegrationModel `json:"result"`
}

type ZeroTrustRiskScoreIntegrationModel struct {
	...
	ReferenceID     types.String      `tfsdk:"reference_id" json:"reference_id,computed_optional"`
