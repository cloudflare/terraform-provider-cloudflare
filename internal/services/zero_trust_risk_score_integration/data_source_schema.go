...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustRiskScoreIntegrationDataSource)(nil)
...
func (d *ZeroTrustRiskScoreIntegrationDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *ZeroTrustRiskScoreIntegrationDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
