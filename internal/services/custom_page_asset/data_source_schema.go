...
var _ datasource.DataSourceWithConfigValidators = (*CustomPageAssetDataSource)(nil)
...
func (d *CustomPageAssetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *CustomPageAssetDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
