...
var _ datasource.DataSourceWithConfigValidators = (*RulesetRuleDataSource)(nil)

func RuleDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Description: "This data source doesn't read data from Cloudflare's API. It can be used to construct rules in memory to pass between modules.",
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				Description: "Internal identifier for the ruleset. This is not an ID of any actual Cloudflare resource and is only used for Terraform's state management. It is generated as a hash of the ruleset configuration and will change whenever the configuration changes.",
				Computed:    true,
			},
			...
			"rules": schema.ListNestedAttribute{
				...
				Computed:    true,
				Optional:    true,
				CustomType:  customfield.NewNestedObjectListType[RulesRulesDataSourceModel](ctx),
...
func (d *RulesetRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = RuleDataSourceSchema(ctx)
}
