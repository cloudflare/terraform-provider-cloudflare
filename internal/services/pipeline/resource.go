...
func (r *PipelineResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
  ...
  _, err = r.client.Pipelines.New(
    ctx,
    pipelines.PipelineNewParams{
...
func (r *PipelineResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
  ...
  res := new(http.Response)
  env := PipelineResultEnvelope{*data}
  _, err = r.client.Pipelines.Update(
    ctx,
    data.ID.ValueString(),
...
func (r *PipelineResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
  var data *PipelineModel = new(PipelineModel)

  path_account_id := ""
  path_pipeline_name := ""
  diags := importpath.ParseImportID(
    req.ID,
    "<account_id>/<pipeline_name>",
    &path_account_id,
    &path_pipeline_name,
  )
  ...
  data.ID = types.StringValue(path_pipeline_name)
