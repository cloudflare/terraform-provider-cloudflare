...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustCasbPolicyDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"actions": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[ZeroTrustCasbPolicyActionsDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"remediation_types": schema.ListNestedAttribute{
						Description: "List of remediation types that will be executed.",
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[ZeroTrustCasbPolicyActionsRemediationTypesDataSourceModel](ctx),
					...
					"webhook_configs": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[ZeroTrustCasbPolicyActionsWebhookConfigsDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"display_name": schema.StringAttribute{
...
func (d *ZeroTrustCasbPolicyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *ZeroTrustCasbPolicyDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
