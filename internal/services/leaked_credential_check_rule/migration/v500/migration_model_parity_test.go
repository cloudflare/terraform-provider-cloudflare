...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/leaked_credential_check_rule/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestLeakedCredentialCheckRuleMigrationModelSchemaParity verifies that TargetLeakedCredentialCheckRuleModel
...
// TargetLeakedCredentialCheckRuleModel will cause this test to fail.
func TestLeakedCredentialCheckRuleMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetLeakedCredentialCheckRuleModel)(nil)
