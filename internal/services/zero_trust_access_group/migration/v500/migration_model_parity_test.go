...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/zero_trust_access_group/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestZeroTrustAccessGroupMigrationModelSchemaParity verifies that TargetV5ZeroTrustAccessGroupModel
// (used in UpgradeFromV0 → resp.State.Set, MoveState → resp.TargetState.Set) stays in sync with the live ResourceSchema.
func TestZeroTrustAccessGroupMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetV5ZeroTrustAccessGroupModel)(nil)
