...
var _ datasource.DataSourceWithConfigValidators = (*APIShieldOperationDiscoveriesDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[APIShieldOperationDiscoveriesResultDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"features": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[APIShieldOperationDiscoveriesFeaturesDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"traffic_stats": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[APIShieldOperationDiscoveriesFeaturesTrafficStatsDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"last_updated": schema.StringAttribute{
											Computed:   true,
											CustomType: timetypes.RFC3339Type{},
...
func (d *APIShieldOperationDiscoveriesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *APIShieldOperationDiscoveriesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
