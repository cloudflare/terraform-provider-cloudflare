...
type APIShieldOperationDiscoveriesResultListDataSourceEnvelope struct {
	Result customfield.NestedObjectList[APIShieldOperationDiscoveriesResultDataSourceModel] `json:"result,computed"`
}

type APIShieldOperationDiscoveriesDataSourceModel struct {
	...
	Result    customfield.NestedObjectList[APIShieldOperationDiscoveriesResultDataSourceModel] `tfsdk:"result"`
}

func (m *APIShieldOperationDiscoveriesDataSourceModel) toListParams(_ context.Context) (params api_gateway.DiscoveryOperationListParams, diags diag.Diagnostics) {
	mHost := []string{}
...
type APIShieldOperationDiscoveriesResultDataSourceModel struct {
	...
	Features    customfield.NestedObject[APIShieldOperationDiscoveriesFeaturesDataSourceModel] `tfsdk:"features" json:"features,computed"`
}

type APIShieldOperationDiscoveriesFeaturesDataSourceModel struct {
	TrafficStats customfield.NestedObject[APIShieldOperationDiscoveriesFeaturesTrafficStatsDataSourceModel] `tfsdk:"traffic_stats" json:"traffic_stats,computed"`
}

type APIShieldOperationDiscoveriesFeaturesTrafficStatsDataSourceModel struct {
	LastUpdated   timetypes.RFC3339 `tfsdk:"last_updated" json:"last_updated,computed" format:"date-time"`
