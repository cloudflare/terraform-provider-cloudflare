...
type DNSZoneTransferIncomingResultDataSourceEnvelope struct {
	Result DNSZoneTransferIncomingDataSourceModel `json:"result,computed"`
}

type DNSZoneTransferIncomingDataSourceModel struct {
...
func (m *DNSZoneTransferIncomingDataSourceModel) toReadParams(_ context.Context) (params dns.ZoneTransferIncomingGetParams, diags diag.Diagnostics) {
