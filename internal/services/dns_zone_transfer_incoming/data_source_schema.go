...
var _ datasource.DataSourceWithConfigValidators = (*DNSZoneTransferIncomingDataSource)(nil)
...
func (d *DNSZoneTransferIncomingDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *DNSZoneTransferIncomingDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
