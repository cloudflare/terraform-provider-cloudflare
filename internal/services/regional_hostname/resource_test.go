		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "hostname", zoneName),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "region_key", "eu"),
					resource.TestCheckResourceAttr(resourceName, "hostname", zoneName),
					resource.TestCheckResourceAttr(resourceName, "routing", "dns"),
				),
			},
...
func testRegionalHostnameBasicConfig(name string, zoneName, regionKey string) string {
	return acctest.LoadTestCase("regionalhostname_basic.tf", name, zoneID, zoneName, regionKey)
}
