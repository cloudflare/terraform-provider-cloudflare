...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/tiered_cache/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestTieredCacheMigrationModelSchemaParity verifies that TargetTieredCacheModel
// (used in UpgradeFromV0 → resp.State.Set) stays in sync with the live ResourceSchema.
func TestTieredCacheMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetTieredCacheModel)(nil)
