...
var _ datasource.DataSourceWithConfigValidators = (*SecondaryDNSTSIGDataSource)(nil)
...
func (d *SecondaryDNSTSIGDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *SecondaryDNSTSIGDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
