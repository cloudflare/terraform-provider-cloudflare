...
type TargetBotManagementModel struct {
	ID                           types.String                                                      `tfsdk:"id"`
	ZoneID                       types.String                                                      `tfsdk:"zone_id"`
	AIBotsMigrationOptOut        types.Bool                                                        `tfsdk:"ai_bots_migration_opt_out"`
	AIBotsProtection             types.String                                                      `tfsdk:"ai_bots_protection"`
	AISearch                     types.String                                                      `tfsdk:"aisearch"`
	AITraining                   types.String                                                      `tfsdk:"ai_training"`
	AIUser                       types.String                                                      `tfsdk:"ai_user"`
	JsdAPIResultsEnabled         types.Bool                                                        `tfsdk:"jsd_api_results_enabled"`
	AutoUpdateModel              types.Bool                                                        `tfsdk:"auto_update_model"`
