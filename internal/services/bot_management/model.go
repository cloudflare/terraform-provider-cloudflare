...
type BotManagementModel struct {
	...
	AutoUpdateModel              types.Bool                                                         `tfsdk:"auto_update_model" json:"auto_update_model,computed_optional,encode_state_for_unknown"`
	CrawlerProtection            types.String                                                       `tfsdk:"crawler_protection" json:"crawler_protection,computed_optional"`
	EnableJS                     types.Bool                                                         `tfsdk:"enable_js" json:"enable_js,computed_optional,encode_state_for_unknown"`
	FightMode                    types.Bool                                                         `tfsdk:"fight_mode" json:"fight_mode,computed_optional,encode_state_for_unknown"`
	...
	SuppressSessionScore         types.Bool                                                         `tfsdk:"suppress_session_score" json:"suppress_session_score,computed_optional,encode_state_for_unknown"`
