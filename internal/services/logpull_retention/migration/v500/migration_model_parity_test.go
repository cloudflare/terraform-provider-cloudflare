...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/logpull_retention/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestLogpullRetentionMigrationModelSchemaParity verifies that TargetLogpullRetentionModel
...
// TargetLogpullRetentionModel will cause this test to fail.
func TestLogpullRetentionMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetLogpullRetentionModel)(nil)
