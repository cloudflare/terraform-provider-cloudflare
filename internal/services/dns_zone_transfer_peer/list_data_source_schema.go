...
var _ datasource.DataSourceWithConfigValidators = (*DNSZoneTransferPeersDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[DNSZoneTransferPeersResultDataSourceModel](ctx),
...
func (d *DNSZoneTransferPeersDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *DNSZoneTransferPeersDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
