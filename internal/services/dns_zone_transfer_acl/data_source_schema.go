...
var _ datasource.DataSourceWithConfigValidators = (*DNSZoneTransferACLDataSource)(nil)
...
func (d *DNSZoneTransferACLDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *DNSZoneTransferACLDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
