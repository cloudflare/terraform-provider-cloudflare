...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/queue/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestQueueMigrationModelSchemaParity verifies that TargetQueueModel
// (used in UpgradeFromLegacyV0 → resp.State.Set) stays in sync with the live ResourceSchema.
func TestQueueMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetQueueModel)(nil)
