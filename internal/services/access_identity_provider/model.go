...
type AccessIdentityProviderResultEnvelope struct {
	Result AccessIdentityProviderModel `json:"result"`
}
...
type AccessIdentityProviderModel struct {
	...
	Config     *AccessIdentityProviderConfigModel                              `tfsdk:"config" json:"config,required"`
	SCIMConfig customfield.NestedObject[AccessIdentityProviderSCIMConfigModel] `tfsdk:"scim_config" json:"scim_config,computed_optional"`
}

func (m AccessIdentityProviderModel) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(m)
}

func (m AccessIdentityProviderModel) MarshalJSONForUpdate(state AccessIdentityProviderModel) (data []byte, err error) {
...
type AccessIdentityProviderConfigModel struct {
	...
	HeaderAttributes         *[]*AccessIdentityProviderConfigHeaderAttributesModel `tfsdk:"header_attributes" json:"header_attributes,optional"`
...
type AccessIdentityProviderConfigHeaderAttributesModel struct {
