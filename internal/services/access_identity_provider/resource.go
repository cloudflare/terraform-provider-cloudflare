...
var _ resource.ResourceWithModifyPlan = &AccessIdentityProviderResource{}
...
func (r *AccessIdentityProviderResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var state *AccessIdentityProviderModel
...
func (r *AccessIdentityProviderResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
