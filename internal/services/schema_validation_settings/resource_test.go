...
func TestAccCloudflareSchemaValidationZoneSettings(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCloudflareSchemaValidationSettings(rndResourceName, zoneID, "block", ptrTo("none")),
			...
			// clear the override
			{
				Config: testAccCloudflareSchemaValidationSettings(rndResourceName, zoneID, "block", ptrTo("null")),
