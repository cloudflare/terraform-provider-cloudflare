...
type ZeroTrustRiskScoringIntegrationResultListDataSourceEnvelope struct {
	Result customfield.NestedObjectList[ZeroTrustRiskScoringIntegrationDataSourceModel] `json:"result,computed"`
}
