...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/zero_trust_tunnel_cloudflared_virtual_network/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestZeroTrustTunnelCloudflaredVirtualNetworkMigrationModelSchemaParity verifies that TargetVirtualNetworkModel
// (used in UpgradeFromV4 → resp.State.Set, MoveState → resp.TargetState.Set) stays in sync with the live ResourceSchema.
func TestZeroTrustTunnelCloudflaredVirtualNetworkMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetVirtualNetworkModel)(nil)
