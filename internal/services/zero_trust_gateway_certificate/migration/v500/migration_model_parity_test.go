...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/zero_trust_gateway_certificate/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestZeroTrustGatewayCertificateMigrationModelSchemaParity verifies that TargetZeroTrustGatewayCertificateModel
// (used in UpgradeFromV4 → resp.State.Set) stays in sync with the live ResourceSchema.
func TestZeroTrustGatewayCertificateMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetZeroTrustGatewayCertificateModel)(nil)
