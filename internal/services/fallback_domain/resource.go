...
var _ resource.ResourceWithConfigure = &FallbackDomainResource{}
var _ resource.ResourceWithModifyPlan = &FallbackDomainResource{}

func NewResource() resource.Resource {
	return &FallbackDomainResource{}
}

// FallbackDomainResource defines the resource implementation.
...
func (r *FallbackDomainResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	env := FallbackDomainResultEnvelope{*data}
...
func (r *FallbackDomainResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
