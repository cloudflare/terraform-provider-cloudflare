						...
						"settings": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"email": schema.ListNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectListType[QueueConsumersSettingsEmailDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
								...
								"pagerduty": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[QueueConsumersSettingsPagerdutyDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"id": schema.StringAttribute{
												Description: "UUID.",
								...
								"webhooks": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[QueueConsumersSettingsWebhooksDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"id": schema.StringAttribute{
												Description: "UUID.",
