...
var _ datasource.DataSourceWithConfigure = (*UserGroupMembersDataSource)(nil)

func NewUserGroupMembersDataSource() datasource.DataSource {
	return &UserGroupMembersDataSource{}
}

func (d *UserGroupMembersDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *UserGroupMembersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *UserGroupMembersDataSourceModel
