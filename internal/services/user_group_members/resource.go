...
var _ resource.ResourceWithConfigure = (*UserGroupMembersResource)(nil)
var _ resource.ResourceWithModifyPlan = (*UserGroupMembersResource)(nil)
var _ resource.ResourceWithImportState = (*UserGroupMembersResource)(nil)
...
func (r *UserGroupMembersResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = r.client.IAM.UserGroups.Members.New(
		ctx,
...
func (r *UserGroupMembersResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	var data = new(UserGroupMembersModel)
	...
	data.UserGroupID = types.StringValue(path_user_group_id)
