...
func TestAccCloudflareZeroTrustNetworkHostnameRoute_Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccZeroTrustNetworkHostnameRouteConfig(rnd, accountID, "original"),
			...
			{
				Config: testAccZeroTrustNetworkHostnameRouteConfig(rnd, accountID, "update"),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue(name, tfjsonpath.New("account_id"), knownvalue.StringExact(accountID)),
			...
			},
			{
				ResourceName:      name,
				ImportState:       true,
				ImportStateIdFunc: testAccCloudflareZeroTrustNetworkHostnameRouteImportStateIdFunc(name),
...
func testAccZeroTrustNetworkHostnameRouteConfig(rnd, accountID string, prefix string) string {
