...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/zero_trust_access_service_token/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestZeroTrustAccessServiceTokenMigrationModelSchemaParity verifies that TargetAccessServiceTokenModel
// (used in UpgradeFromV4 → resp.State.Set, MoveState → resp.TargetState.Set) stays in sync with the live ResourceSchema.
func TestZeroTrustAccessServiceTokenMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetAccessServiceTokenModel)(nil)
