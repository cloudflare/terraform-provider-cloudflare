...
type ZeroTrustDevicePostureRuleModel struct {
	...
	Input       *ZeroTrustDevicePostureRuleInputModel    `tfsdk:"input" json:"input"`
	Match       *[]*ZeroTrustDevicePostureRuleMatchModel `tfsdk:"match" json:"match"`
}
...
type ZeroTrustDevicePostureRuleInputModel struct {
	...
	Locations        *ZeroTrustDevicePostureRuleInputLocationsModel `tfsdk:"locations" json:"locations"`
