...
type ZeroTrustDevicePostureRulesResultDataSourceModel struct {
	...
	Input       *ZeroTrustDevicePostureRulesInputDataSourceModel    `tfsdk:"input" json:"input,computed_optional"`
	Match       *[]*ZeroTrustDevicePostureRulesMatchDataSourceModel `tfsdk:"match" json:"match,computed_optional"`
...
type ZeroTrustDevicePostureRulesInputDataSourceModel struct {
	...
	Locations        *ZeroTrustDevicePostureRulesInputLocationsDataSourceModel `tfsdk:"locations" json:"locations,computed_optional"`
