...
type ZeroTrustDevicePostureRulesResultListDataSourceEnvelope struct {
	Result *[]*ZeroTrustDevicePostureRulesResultDataSourceModel `json:"result,computed"`
}
...
type ZeroTrustDevicePostureRulesResultDataSourceModel struct {
	...
	Input       *ZeroTrustDevicePostureRulesInputDataSourceModel    `tfsdk:"input" json:"input"`
	Match       *[]*ZeroTrustDevicePostureRulesMatchDataSourceModel `tfsdk:"match" json:"match"`
...
type ZeroTrustDevicePostureRulesInputDataSourceModel struct {
	...
	Locations        *ZeroTrustDevicePostureRulesInputLocationsDataSourceModel `tfsdk:"locations" json:"locations"`
