...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/workers_kv_namespace/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestWorkersKVNamespaceMigrationModelSchemaParity verifies that TargetWorkersKVNamespaceModel
// (used in UpgradeFromV0 → resp.State.Set) stays in sync with the live ResourceSchema.
func TestWorkersKVNamespaceMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetWorkersKVNamespaceModel)(nil)
