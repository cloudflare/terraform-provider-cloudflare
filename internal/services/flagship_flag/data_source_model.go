...
type FlagshipFlagDataSourceModel struct {
	ID               types.String                                                   `tfsdk:"id" path:"flag_key,computed"`
	...
	Filter           *FlagshipFlagFindOneByDataSourceModel                          `tfsdk:"filter"`
}
...
func (m *FlagshipFlagDataSourceModel) toListParams(_ context.Context) (params flagship.AppFlagListParams, diags diag.Diagnostics) {
