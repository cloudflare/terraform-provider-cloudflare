...
// to cloudflare_zero_trust_dlp_predefined_profile.
// This is triggered when users use the `moved` block (Terraform 1.8+):
//
//	moved {
//	    from = cloudflare_dlp_profile.example
//	    to   = cloudflare_zero_trust_dlp_predefined_profile.example
//	}
func MoveState(
	ctx context.Context,
	...
	tflog.Info(ctx, "Starting state move to cloudflare_zero_trust_dlp_predefined_profile",
	...
	tflog.Info(ctx, "State move to cloudflare_zero_trust_dlp_predefined_profile completed successfully")
}
