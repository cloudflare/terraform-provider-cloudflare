...
var _ datasource.DataSourceWithConfigValidators = (*SecondaryDNSPeersDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[SecondaryDNSPeersResultDataSourceModel](ctx),
...
func (d *SecondaryDNSPeersDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *SecondaryDNSPeersDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
