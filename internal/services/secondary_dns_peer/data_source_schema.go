...
var _ datasource.DataSourceWithConfigValidators = (*SecondaryDNSPeerDataSource)(nil)
...
func (d *SecondaryDNSPeerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *SecondaryDNSPeerDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
