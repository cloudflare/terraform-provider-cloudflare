...
var _ datasource.DataSourceWithConfigure = (*ShareDataSource)(nil)
...
func (d *ShareDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ShareDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if data.Filter != nil {
		...
		env := SharesResultListDataSourceEnvelope{}
		page, err := d.client.ResourceSharing.List(ctx, params)
		if err != nil {
	...
	env := ShareResultDataSourceEnvelope{*data}
	_, err := d.client.ResourceSharing.Get(
		ctx,
