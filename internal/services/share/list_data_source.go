...
var _ datasource.DataSourceWithConfigure = (*SharesDataSource)(nil)
...
func (d *SharesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *SharesDataSourceModel
	...
	result, diags := customfield.NewObjectListFromAttributes[SharesResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
