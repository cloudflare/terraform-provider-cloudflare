...
var _ datasource.DataSourceWithConfigValidators = (*EmailSecurityAllowPoliciesDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[EmailSecurityAllowPoliciesResultDataSourceModel](ctx),
...
func (d *EmailSecurityAllowPoliciesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *EmailSecurityAllowPoliciesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
