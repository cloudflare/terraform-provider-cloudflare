...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/notification_policy/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestNotificationPolicyMigrationModelSchemaParity verifies that TargetNotificationPolicyModel
// (used in UpgradeFromV4 → resp.State.Set) stays in sync with the live ResourceSchema.
func TestNotificationPolicyMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetNotificationPolicyModel)(nil)
