...
type TeamsRulesResultListDataSourceEnvelope struct {
	Result *[]*TeamsRulesResultDataSourceModel `json:"result,computed"`
}

type TeamsRulesDataSourceModel struct {
	AccountID types.String                        `tfsdk:"account_id" path:"account_id"`
	MaxItems  types.Int64                         `tfsdk:"max_items"`
	Result    *[]*TeamsRulesResultDataSourceModel `tfsdk:"result"`
}

type TeamsRulesResultDataSourceModel struct {
	...
	RuleSettings  *TeamsRulesRuleSettingsDataSourceModel `tfsdk:"rule_settings" json:"rule_settings"`
	Schedule      *TeamsRulesScheduleDataSourceModel     `tfsdk:"schedule" json:"schedule"`
	Traffic       types.String                           `tfsdk:"traffic" json:"traffic"`
	UpdatedAt     timetypes.RFC3339                      `tfsdk:"updated_at" json:"updated_at,computed"`
}

type TeamsRulesRuleSettingsDataSourceModel struct {
	...
	AuditSSH                        *TeamsRulesRuleSettingsAuditSSHDataSourceModel             `tfsdk:"audit_ssh" json:"audit_ssh"`
	BISOAdminControls               *TeamsRulesRuleSettingsBISOAdminControlsDataSourceModel    `tfsdk:"biso_admin_controls" json:"biso_admin_controls"`
	...
	CheckSession                    *TeamsRulesRuleSettingsCheckSessionDataSourceModel         `tfsdk:"check_session" json:"check_session"`
	DNSResolvers                    *TeamsRulesRuleSettingsDNSResolversDataSourceModel         `tfsdk:"dns_resolvers" json:"dns_resolvers"`
	Egress                          *TeamsRulesRuleSettingsEgressDataSourceModel               `tfsdk:"egress" json:"egress"`
	...
	L4override                      *TeamsRulesRuleSettingsL4overrideDataSourceModel           `tfsdk:"l4override" json:"l4override"`
	NotificationSettings            *TeamsRulesRuleSettingsNotificationSettingsDataSourceModel `tfsdk:"notification_settings" json:"notification_settings"`
	...
	PayloadLog                      *TeamsRulesRuleSettingsPayloadLogDataSourceModel           `tfsdk:"payload_log" json:"payload_log"`
	ResolveDNSThroughCloudflare     types.Bool                                                 `tfsdk:"resolve_dns_through_cloudflare" json:"resolve_dns_through_cloudflare"`
	UntrustedCERT                   *TeamsRulesRuleSettingsUntrustedCERTDataSourceModel        `tfsdk:"untrusted_cert" json:"untrusted_cert"`
}

type TeamsRulesRuleSettingsAuditSSHDataSourceModel struct {
	CommandLogging types.Bool `tfsdk:"command_logging" json:"command_logging"`
}

type TeamsRulesRuleSettingsBISOAdminControlsDataSourceModel struct {
...
type TeamsRulesRuleSettingsCheckSessionDataSourceModel struct {
	Duration types.String `tfsdk:"duration" json:"duration"`
	Enforce  types.Bool   `tfsdk:"enforce" json:"enforce"`
}

type TeamsRulesRuleSettingsDNSResolversDataSourceModel struct {
	IPV4 *[]*TeamsRulesRuleSettingsDNSResolversIPV4DataSourceModel `tfsdk:"ipv4" json:"ipv4"`
	IPV6 *[]*TeamsRulesRuleSettingsDNSResolversIPV6DataSourceModel `tfsdk:"ipv6" json:"ipv6"`
}

type TeamsRulesRuleSettingsDNSResolversIPV4DataSourceModel struct {
...
type TeamsRulesRuleSettingsDNSResolversIPV6DataSourceModel struct {
	IP                         types.String `tfsdk:"ip" json:"ip,computed"`
	Port                       types.Int64  `tfsdk:"port" json:"port"`
	RouteThroughPrivateNetwork types.Bool   `tfsdk:"route_through_private_network" json:"route_through_private_network"`
	VnetID                     types.String `tfsdk:"vnet_id" json:"vnet_id"`
...
type TeamsRulesRuleSettingsEgressDataSourceModel struct {
...
type TeamsRulesRuleSettingsL4overrideDataSourceModel struct {
	IP   types.String `tfsdk:"ip" json:"ip"`
	Port types.Int64  `tfsdk:"port" json:"port"`
}

type TeamsRulesRuleSettingsNotificationSettingsDataSourceModel struct {
	Enabled    types.Bool   `tfsdk:"enabled" json:"enabled"`
	Msg        types.String `tfsdk:"msg" json:"msg"`
	SupportURL types.String `tfsdk:"support_url" json:"support_url"`
}

type TeamsRulesRuleSettingsPayloadLogDataSourceModel struct {
	Enabled types.Bool `tfsdk:"enabled" json:"enabled"`
}

type TeamsRulesRuleSettingsUntrustedCERTDataSourceModel struct {
	Action types.String `tfsdk:"action" json:"action"`
}

type TeamsRulesScheduleDataSourceModel struct {
