...
type APIShieldDiscoveryOperationResultListDataSourceEnvelope struct {
	Result customfield.NestedObjectList[APIShieldDiscoveryOperationDataSourceModel] `json:"result,computed"`
}

type APIShieldDiscoveryOperationDataSourceModel struct {
	...
	Features    customfield.NestedObject[APIShieldDiscoveryOperationFeaturesDataSourceModel] `tfsdk:"features" json:"features,computed"`
	Filter      *APIShieldDiscoveryOperationFindOneByDataSourceModel                         `tfsdk:"filter"`
}

func (m *APIShieldDiscoveryOperationDataSourceModel) toListParams(_ context.Context) (params api_gateway.DiscoveryOperationListParams, diags diag.Diagnostics) {
	mFilterHost := []string{}
...
type APIShieldDiscoveryOperationFeaturesDataSourceModel struct {
	TrafficStats customfield.NestedObject[APIShieldDiscoveryOperationFeaturesTrafficStatsDataSourceModel] `tfsdk:"traffic_stats" json:"traffic_stats,computed"`
}

type APIShieldDiscoveryOperationFeaturesTrafficStatsDataSourceModel struct {
	LastUpdated   timetypes.RFC3339 `tfsdk:"last_updated" json:"last_updated,computed" format:"date-time"`
...
type APIShieldDiscoveryOperationFindOneByDataSourceModel struct {
