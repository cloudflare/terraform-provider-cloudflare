...
var _ datasource.DataSourceWithConfigValidators = (*APIShieldDiscoveryOperationDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"features": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[APIShieldDiscoveryOperationFeaturesDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"traffic_stats": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[APIShieldDiscoveryOperationFeaturesTrafficStatsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"last_updated": schema.StringAttribute{
								Computed:   true,
								CustomType: timetypes.RFC3339Type{},
...
func (d *APIShieldDiscoveryOperationDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *APIShieldDiscoveryOperationDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
