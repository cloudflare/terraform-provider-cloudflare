...
type DLPPredefinedProfileDataSource struct {
	client *cloudflare.Client
}

var _ datasource.DataSourceWithConfigure = &DLPPredefinedProfileDataSource{}

func NewDLPPredefinedProfileDataSource() datasource.DataSource {
	return &DLPPredefinedProfileDataSource{}
}

func (d *DLPPredefinedProfileDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
