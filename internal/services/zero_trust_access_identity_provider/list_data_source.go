...
var _ datasource.DataSourceWithConfigure = &ZeroTrustAccessIdentityProvidersDataSource{}
...
func (d *ZeroTrustAccessIdentityProvidersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	items := &[]*ZeroTrustAccessIdentityProvidersResultDataSourceModel{}
	env := ZeroTrustAccessIdentityProvidersResultListDataSourceEnvelope{items}
	maxItems := int(data.MaxItems.ValueInt64())
	acc := []*ZeroTrustAccessIdentityProvidersResultDataSourceModel{}
