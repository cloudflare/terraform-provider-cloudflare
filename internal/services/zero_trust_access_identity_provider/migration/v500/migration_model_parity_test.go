...
// TestZeroTrustAccessIdentityProviderMigrationModelSchemaParity verifies that TargetAccessIdentityProviderModel
...
func TestZeroTrustAccessIdentityProviderMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetAccessIdentityProviderModel)(nil)
