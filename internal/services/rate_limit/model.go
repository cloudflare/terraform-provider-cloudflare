...
type RateLimitModel struct {
	...
	Period      types.Float64         `tfsdk:"period" json:"period,required,no_refresh"`
	Threshold   types.Float64         `tfsdk:"threshold" json:"threshold,required,no_refresh"`
	Action      *RateLimitActionModel `tfsdk:"action" json:"action,required,no_refresh"`
	Match       *RateLimitMatchModel  `tfsdk:"match" json:"match,required,no_refresh"`
}
