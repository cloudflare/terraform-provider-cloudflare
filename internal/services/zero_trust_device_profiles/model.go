...
type ZeroTrustDeviceProfilesModel struct {
	...
	Exclude             *[]*ZeroTrustDeviceProfilesExcludeModel         `tfsdk:"exclude" json:"exclude,computed"`
	FallbackDomains     *[]*ZeroTrustDeviceProfilesFallbackDomainsModel `tfsdk:"fallback_domains" json:"fallback_domains,computed"`
	Include             *[]*ZeroTrustDeviceProfilesIncludeModel         `tfsdk:"include" json:"include,computed"`
	TargetTests         *[]*ZeroTrustDeviceProfilesTargetTestsModel     `tfsdk:"target_tests" json:"target_tests,computed"`
}
