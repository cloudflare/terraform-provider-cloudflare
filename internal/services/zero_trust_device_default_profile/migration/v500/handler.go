...
//
// This handles the full transformation from legacy device profile resources to the default profile:
// - Resource type unchanged (already moved via MoveState)
// - Schema version: 0 → 500
// - Field transformations: See TransformToDefaultProfile for details
