...
type WorkerDomainsDataSource struct {
	client *cloudflare.Client
}

var _ datasource.DataSourceWithConfigure = &WorkerDomainsDataSource{}

func NewWorkerDomainsDataSource() datasource.DataSource {
	return &WorkerDomainsDataSource{}
}

func (d *WorkerDomainsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (r *WorkerDomainsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	items := &[]*WorkerDomainsResultDataSourceModel{}
	env := WorkerDomainsResultListDataSourceEnvelope{items}
