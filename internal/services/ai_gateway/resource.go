...
var _ resource.ResourceWithModifyPlan = (*AIGatewayResource)(nil)
...
func (r *AIGatewayResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
