...
type AIGatewayModel struct {
	...
	ByokOnly                types.Bool                                          `tfsdk:"byok_only" json:"byok_only,optional"`
...
type AIGatewaySpendLimitsModel struct {
	Enabled types.Bool                                                   `tfsdk:"enabled" json:"enabled,computed_optional"`
	Rules   customfield.NestedObjectList[AIGatewaySpendLimitsRulesModel] `tfsdk:"rules" json:"rules,computed_optional"`
}
