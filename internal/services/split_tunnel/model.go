...
type SplitTunnelResultEnvelope struct {
	Result SplitTunnelModel `json:"result"`
}

type SplitTunnelModel struct {
	...
	Exclude                    *[]*SplitTunnelExcludeModel                                   `tfsdk:"exclude" json:"exclude,optional"`
	Include                    *[]*SplitTunnelIncludeModel                                   `tfsdk:"include" json:"include,optional"`
	ServiceModeV2              *SplitTunnelServiceModeV2Model                                `tfsdk:"service_mode_v2" json:"service_mode_v2,optional"`
	...
	FallbackDomains            customfield.NestedObjectList[SplitTunnelFallbackDomainsModel] `tfsdk:"fallback_domains" json:"fallback_domains,computed"`
}

func (m SplitTunnelModel) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(m)
}

func (m SplitTunnelModel) MarshalJSONForUpdate(state SplitTunnelModel) (data []byte, err error) {
	return apijson.MarshalForPatch(m, state)
}

type SplitTunnelExcludeModel struct {
	Address     types.String `tfsdk:"address" json:"address,optional"`
	Description types.String `tfsdk:"description" json:"description,optional"`
	Host        types.String `tfsdk:"host" json:"host,optional"`
}

type SplitTunnelIncludeModel struct {
	Address     types.String `tfsdk:"address" json:"address,optional"`
	Description types.String `tfsdk:"description" json:"description,optional"`
	Host        types.String `tfsdk:"host" json:"host,optional"`
}

type SplitTunnelServiceModeV2Model struct {
	Mode types.String  `tfsdk:"mode" json:"mode,optional"`
	Port types.Float64 `tfsdk:"port" json:"port,optional"`
}

type SplitTunnelFallbackDomainsModel struct {
