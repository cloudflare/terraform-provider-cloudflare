...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/regional_tiered_cache/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestRegionalTieredCacheMigrationModelSchemaParity verifies that TargetRegionalTieredCacheModel
// (used in UpgradeFromV4 → resp.State.Set) stays in sync with the live ResourceSchema.
func TestRegionalTieredCacheMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetRegionalTieredCacheModel)(nil)
