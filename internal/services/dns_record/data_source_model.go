...
func (m *DNSRecordDataSourceModel) toReadParams() (params dns.RecordGetParams, diags diag.Diagnostics) {
...
func (m *DNSRecordDataSourceModel) toListParams() (params dns.RecordListParams, diags diag.Diagnostics) {
