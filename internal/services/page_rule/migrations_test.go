...
func TestMigrateCloudflarePageRule_Basic(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			version:  "5.0.0",
			configFn: testAccCloudflarePageRuleMigrationConfigV5Basic,
		},
		{
...
func TestMigrateCloudflarePageRule_CacheDeceptionArmor(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name:     "from_v5_0_0",
			version:  "5.0.0",
			configFn: testAccCloudflarePageRuleMigrationConfigV5CacheDeceptionArmor,
		},
	}
...
func TestMigrateCloudflarePageRule_ForwardingURL(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name:     "from_v5_0_0",
			version:  "5.0.0",
			configFn: testAccCloudflarePageRuleMigrationConfigV5ForwardingURL,
		},
	}
				...
				Steps: []resource.TestStep{
					...
					},
					{
						...
						ConfigStateChecks: []statecheck.StateCheck{
							...
							statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("actions.browser_cache_ttl"), knownvalue.Float64Exact(3600)),
							statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("actions.edge_cache_ttl"), knownvalue.Float64Exact(7200)),
						},
					},
					{
						ProtoV6ProviderFactories: acctest.TestAccProtoV6ProviderFactories,
						...
						ConfigStateChecks: []statecheck.StateCheck{
							...
							statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("actions.browser_cache_ttl"), knownvalue.Float64Exact(3600)),
							statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("actions.edge_cache_ttl"), knownvalue.Float64Exact(7200)),
							statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("actions.security_level"), knownvalue.StringExact("high")),
							statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("actions.ssl"), knownvalue.StringExact("flexible")),
						},
					},
				},
			})
