...
func (m *AccountDNSSettingsInternalViewDataSourceModel) toReadParams(_ context.Context) (params dns.SettingZoneViewGetParams, diags diag.Diagnostics) {
	params = dns.SettingZoneViewGetParams{
...
func (m *AccountDNSSettingsInternalViewDataSourceModel) toListParams(_ context.Context) (params dns.SettingZoneViewListParams, diags diag.Diagnostics) {
	params = dns.SettingZoneViewListParams{
		AccountID: cloudflare.F(m.AccountID.ValueString()),
	}

	if !m.Filter.Direction.IsNull() {
		params.Direction = cloudflare.F(dns.SettingZoneViewListParamsDirection(m.Filter.Direction.ValueString()))
	}
	if !m.Filter.Match.IsNull() {
		params.Match = cloudflare.F(dns.SettingZoneViewListParamsMatch(m.Filter.Match.ValueString()))
	}
	if m.Filter.Name != nil {
		paramsName := dns.SettingZoneViewListParamsName{}
	...
	if !m.Filter.Order.IsNull() {
		params.Order = cloudflare.F(dns.SettingZoneViewListParamsOrder(m.Filter.Order.ValueString()))
	}
