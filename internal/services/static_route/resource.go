...
var _ resource.ResourceWithModifyPlan = &StaticRouteResource{}
...
func (r *StaticRouteResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
