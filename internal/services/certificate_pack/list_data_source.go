...
var _ datasource.DataSourceWithConfigure = &CertificatePacksDataSource{}
...
func (r *CertificatePacksDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	items := &[]*CertificatePacksItemsDataSourceModel{}
	env := CertificatePacksResultListDataSourceEnvelope{items}
	maxItems := int(data.MaxItems.ValueInt64())
	acc := []*CertificatePacksItemsDataSourceModel{}
