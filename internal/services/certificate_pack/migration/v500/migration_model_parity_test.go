...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/certificate_pack/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestCertificatePackMigrationModelSchemaParity verifies that TargetCertificatePackModel
...
// TargetCertificatePackModel will cause this test to fail.
func TestCertificatePackMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetCertificatePackModel)(nil)
