...
type MagicTransitConnectorModel struct {
	...
	LastHeartbeat                types.String                      `tfsdk:"last_heartbeat" json:"last_heartbeat,computed,no_refresh"`
	LastSeenVersion              types.String                      `tfsdk:"last_seen_version" json:"last_seen_version,computed,no_refresh"`
