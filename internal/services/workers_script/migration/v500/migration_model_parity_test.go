...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/workers_script/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestWorkersScriptMigrationModelSchemaParity verifies that TargetWorkersScriptModel
// (used in UpgradeFromV0 → resp.State.Set, MoveState → resp.TargetState.Set) stays in sync with the live ResourceSchema.
func TestWorkersScriptMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetWorkersScriptModel)(nil)
