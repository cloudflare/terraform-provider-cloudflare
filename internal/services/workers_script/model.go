...
type WorkersScriptMetadataModel struct {
	Assets             *WorkersScriptMetadataAssetsModel        `tfsdk:"assets" json:"assets,computed_optional"`
	Bindings           *[]*WorkersScriptMetadataBindingsModel   `tfsdk:"bindings" json:"bindings,computed_optional"`
	...
	Migrations         *WorkersScriptMetadataMigrationsModel    `tfsdk:"migrations" json:"migrations,computed_optional"`
	Observability      *WorkersScriptMetadataObservabilityModel `tfsdk:"observability" json:"observability,computed_optional"`
	Placement          *WorkersScriptMetadataPlacementModel     `tfsdk:"placement" json:"placement,computed_optional"`
