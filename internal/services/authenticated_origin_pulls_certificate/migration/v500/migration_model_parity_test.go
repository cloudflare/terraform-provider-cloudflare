...
// TestAuthenticatedOriginPullsCertificateMigrationModelSchemaParity verifies that V5Model
...
func TestAuthenticatedOriginPullsCertificateMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
