...
// TestMigrateAPIToken_V0ToV1_Basic tests state schema migration from v0 to v1
// This ensures the migration from JSON string policies to Dynamic policies works correctly
func TestMigrateAPIToken_V0ToV1_Basic(t *testing.T) {
...
// TestMigrateAPIToken_V0ToV1_ComplexPolicies tests migration with multiple policies
// including both simple string resources and nested object resources
func TestMigrateAPIToken_V0ToV1_ComplexPolicies(t *testing.T) {
	rnd := utils.GenerateRandomResourceName()
	resourceName := "cloudflare_api_token." + rnd
...
// TestMigrateAPIToken_V0ToV1_MinimalPolicy tests migration with minimal policy structure
func TestMigrateAPIToken_V0ToV1_MinimalPolicy(t *testing.T) {
	rnd := utils.GenerateRandomResourceName()
	resourceName := "cloudflare_api_token." + rnd
	accountID := os.Getenv("CLOUDFLARE_ACCOUNT_ID")
