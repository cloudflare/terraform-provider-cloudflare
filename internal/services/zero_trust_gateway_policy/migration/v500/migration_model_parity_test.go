...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/zero_trust_gateway_policy/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestZeroTrustGatewayPolicyMigrationModelSchemaParity verifies that TargetZeroTrustGatewayPolicyModel
...
func TestZeroTrustGatewayPolicyMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetZeroTrustGatewayPolicyModel)(nil)
