...
type ZeroTrustGatewayPoliciesResultListDataSourceEnvelope struct {
	Result *[]*ZeroTrustGatewayPoliciesResultDataSourceModel `json:"result,computed"`
}

type ZeroTrustGatewayPoliciesDataSourceModel struct {
	AccountID types.String                                      `tfsdk:"account_id" path:"account_id"`
	MaxItems  types.Int64                                       `tfsdk:"max_items"`
	Result    *[]*ZeroTrustGatewayPoliciesResultDataSourceModel `tfsdk:"result"`
}
...
type ZeroTrustGatewayPoliciesResultDataSourceModel struct {
	...
	RuleSettings  *ZeroTrustGatewayPoliciesRuleSettingsDataSourceModel `tfsdk:"rule_settings" json:"rule_settings"`
	Schedule      *ZeroTrustGatewayPoliciesScheduleDataSourceModel     `tfsdk:"schedule" json:"schedule"`
...
type ZeroTrustGatewayPoliciesRuleSettingsDataSourceModel struct {
	...
	AuditSSH                        *ZeroTrustGatewayPoliciesRuleSettingsAuditSSHDataSourceModel             `tfsdk:"audit_ssh" json:"audit_ssh"`
	BISOAdminControls               *ZeroTrustGatewayPoliciesRuleSettingsBISOAdminControlsDataSourceModel    `tfsdk:"biso_admin_controls" json:"biso_admin_controls"`
	...
	CheckSession                    *ZeroTrustGatewayPoliciesRuleSettingsCheckSessionDataSourceModel         `tfsdk:"check_session" json:"check_session"`
	DNSResolvers                    *ZeroTrustGatewayPoliciesRuleSettingsDNSResolversDataSourceModel         `tfsdk:"dns_resolvers" json:"dns_resolvers"`
	Egress                          *ZeroTrustGatewayPoliciesRuleSettingsEgressDataSourceModel               `tfsdk:"egress" json:"egress"`
	...
	L4override                      *ZeroTrustGatewayPoliciesRuleSettingsL4overrideDataSourceModel           `tfsdk:"l4override" json:"l4override"`
	NotificationSettings            *ZeroTrustGatewayPoliciesRuleSettingsNotificationSettingsDataSourceModel `tfsdk:"notification_settings" json:"notification_settings"`
	...
	PayloadLog                      *ZeroTrustGatewayPoliciesRuleSettingsPayloadLogDataSourceModel           `tfsdk:"payload_log" json:"payload_log"`
	ResolveDNSThroughCloudflare     types.Bool                                                               `tfsdk:"resolve_dns_through_cloudflare" json:"resolve_dns_through_cloudflare"`
	UntrustedCERT                   *ZeroTrustGatewayPoliciesRuleSettingsUntrustedCERTDataSourceModel        `tfsdk:"untrusted_cert" json:"untrusted_cert"`
}
...
type ZeroTrustGatewayPoliciesRuleSettingsDNSResolversDataSourceModel struct {
	IPV4 *[]*ZeroTrustGatewayPoliciesRuleSettingsDNSResolversIPV4DataSourceModel `tfsdk:"ipv4" json:"ipv4"`
	IPV6 *[]*ZeroTrustGatewayPoliciesRuleSettingsDNSResolversIPV6DataSourceModel `tfsdk:"ipv6" json:"ipv6"`
}
