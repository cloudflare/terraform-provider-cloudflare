...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/mtls_certificate/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestMTLSCertificateMigrationModelSchemaParity verifies that TargetMTLSCertificateModel
// (used in UpgradeFromV4 → resp.State.Set) stays in sync with the live ResourceSchema.
func TestMTLSCertificateMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetMTLSCertificateModel)(nil)
