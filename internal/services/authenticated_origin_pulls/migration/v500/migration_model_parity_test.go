...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/authenticated_origin_pulls/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestAuthenticatedOriginPullsMigrationModelSchemaParity verifies that TargetAuthenticatedOriginPullsModel
...
// TargetAuthenticatedOriginPullsModel will cause this test to fail.
func TestAuthenticatedOriginPullsMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetAuthenticatedOriginPullsModel)(nil)
