...
type AccessKeysConfigurationDataSource struct {
	client *cloudflare.Client
}

var _ datasource.DataSourceWithConfigure = &AccessKeysConfigurationDataSource{}

func NewAccessKeysConfigurationDataSource() datasource.DataSource {
	return &AccessKeysConfigurationDataSource{}
}

func (d *AccessKeysConfigurationDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
