...
// TestLoadBalancerMonitorMigrationModelSchemaParity verifies that TargetLoadBalancerMonitorModel
...
// TargetLoadBalancerMonitorModel will cause this test to fail.
func TestLoadBalancerMonitorMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetLoadBalancerMonitorModel)(nil)
