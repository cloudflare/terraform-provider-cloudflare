...
func (d *DevicePostureRulesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *DevicePostureRulesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
