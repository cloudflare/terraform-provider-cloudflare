...
type DevicePostureRulesItemsDataSourceModel struct {
	...
	Input       *DevicePostureRulesItemsInputDataSourceModel    `tfsdk:"input" json:"input"`
	Match       *[]*DevicePostureRulesItemsMatchDataSourceModel `tfsdk:"match" json:"match"`
...
type DevicePostureRulesItemsInputDataSourceModel struct {
	...
	Locations        *DevicePostureRulesItemsInputLocationsDataSourceModel `tfsdk:"locations" json:"locations"`
...
type DevicePostureRulesItemsInputLocationsDataSourceModel struct {
