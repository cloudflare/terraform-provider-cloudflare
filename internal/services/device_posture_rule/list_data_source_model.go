...
type DevicePostureRulesResultListDataSourceEnvelope struct {
	Result *[]*DevicePostureRulesResultDataSourceModel `json:"result,computed"`
}

type DevicePostureRulesDataSourceModel struct {
	AccountID types.String                                `tfsdk:"account_id" path:"account_id"`
	MaxItems  types.Int64                                 `tfsdk:"max_items"`
	Result    *[]*DevicePostureRulesResultDataSourceModel `tfsdk:"result"`
}

type DevicePostureRulesResultDataSourceModel struct {
	ID          types.String                               `tfsdk:"id" json:"id"`
	Description types.String                               `tfsdk:"description" json:"description"`
	Expiration  types.String                               `tfsdk:"expiration" json:"expiration"`
	Input       *DevicePostureRulesInputDataSourceModel    `tfsdk:"input" json:"input"`
	Match       *[]*DevicePostureRulesMatchDataSourceModel `tfsdk:"match" json:"match"`
	Name        types.String                               `tfsdk:"name" json:"name"`
	Schedule    types.String                               `tfsdk:"schedule" json:"schedule"`
	Type        types.String                               `tfsdk:"type" json:"type"`
}

type DevicePostureRulesInputDataSourceModel struct {
	...
	Locations        *DevicePostureRulesInputLocationsDataSourceModel `tfsdk:"locations" json:"locations"`
...
type DevicePostureRulesInputLocationsDataSourceModel struct {
	Paths       *[]types.String `tfsdk:"paths" json:"paths"`
	TrustStores *[]types.String `tfsdk:"trust_stores" json:"trust_stores"`
}

type DevicePostureRulesMatchDataSourceModel struct {
