...
type DNSSettingsInternalViewsResultListDataSourceEnvelope struct {
	Result customfield.NestedObjectList[DNSSettingsInternalViewsResultDataSourceModel] `json:"result,computed"`
}

type DNSSettingsInternalViewsDataSourceModel struct {
	...
	Result    customfield.NestedObjectList[DNSSettingsInternalViewsResultDataSourceModel] `tfsdk:"result"`
}

func (m *DNSSettingsInternalViewsDataSourceModel) toListParams(_ context.Context) (params dns.SettingViewListParams, diags diag.Diagnostics) {
	params = dns.SettingViewListParams{
		AccountID: cloudflare.F(m.AccountID.ValueString()),
	}

	if !m.Direction.IsNull() {
		params.Direction = cloudflare.F(dns.SettingViewListParamsDirection(m.Direction.ValueString()))
	}
	if !m.Match.IsNull() {
		params.Match = cloudflare.F(dns.SettingViewListParamsMatch(m.Match.ValueString()))
	}
	if m.Name != nil {
	...
	if !m.Order.IsNull() {
		params.Order = cloudflare.F(dns.SettingViewListParamsOrder(m.Order.ValueString()))
	}
	if !m.ZoneID.IsNull() {
...
type DNSSettingsInternalViewsNameDataSourceModel struct {
...
type DNSSettingsInternalViewsResultDataSourceModel struct {
