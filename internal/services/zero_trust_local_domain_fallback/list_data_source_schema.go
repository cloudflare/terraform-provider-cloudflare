...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustLocalDomainFallbacksDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[ZeroTrustLocalDomainFallbacksResultDataSourceModel](ctx),
