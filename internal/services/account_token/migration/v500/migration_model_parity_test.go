...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/account_token/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestAccountTokenMigrationModelSchemaParity verifies that TargetAccountTokenModelV500
...
// TargetAccountTokenModelV500 will cause this test to fail.
func TestAccountTokenMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetAccountTokenModelV500)(nil)
