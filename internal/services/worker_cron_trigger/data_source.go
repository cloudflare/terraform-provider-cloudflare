...
type WorkerCronTriggerDataSource struct {
	client *cloudflare.Client
}

var _ datasource.DataSourceWithConfigure = &WorkerCronTriggerDataSource{}

func NewWorkerCronTriggerDataSource() datasource.DataSource {
	return &WorkerCronTriggerDataSource{}
}

func (d *WorkerCronTriggerDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
