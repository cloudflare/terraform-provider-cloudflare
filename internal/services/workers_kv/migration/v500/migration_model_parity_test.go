...
import (
	...
	v500 "github.com/cloudflare/terraform-provider-cloudflare/internal/services/workers_kv/migration/v500"
	"github.com/cloudflare/terraform-provider-cloudflare/internal/test_helpers"
)

// TestWorkersKVMigrationModelSchemaParity verifies that TargetWorkersKVModel
// (used in UpgradeFromV0 → resp.State.Set) stays in sync with the live ResourceSchema.
func TestWorkersKVMigrationModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*v500.TargetWorkersKVModel)(nil)
