...
type TeamsProxyEndpointDataSource struct {
	client *cloudflare.Client
}

var _ datasource.DataSourceWithConfigure = &TeamsProxyEndpointDataSource{}

func NewTeamsProxyEndpointDataSource() datasource.DataSource {
	return &TeamsProxyEndpointDataSource{}
}

func (d *TeamsProxyEndpointDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
