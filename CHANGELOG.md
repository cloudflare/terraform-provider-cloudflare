...
* resource/cloudflare_ruleset: add support for `score_per_period` and `score_response_header_name` ([#2176](https://github.com/cloudflare/terraform-provider-cloudflare/issues/2176))
