...
* `resource/cloudflare_record`: Update validation to allow PTR records ([9a8fd43](https://github.com/terraform-providers/terraform-provider-cloudflare/commit/9a8fd43))
...
* **New Resource:** `cloudflare_workers_kv_namespace` ([#443](https://github.com/terraform-providers/terraform-provider-cloudflare/issues/443))
...
* `resource/cloudflare_spectrum_application`: Spectrum origin_port is optional ([#549](https://github.com/terraform-providers/terraform-provider-cloudflare/issues/549))
