...
`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			migration, err := NewBaseMigration([]byte(tt.yamlContent))
			if tt.expectError {
				assert.Error(t, err)
...
func TestBaseMigration_AttributeRenames(t *testing.T) {
	yamlContent := `
...
config:
  attribute_renames:
    ...
    old_attr2: new_attr2
`
	migration, err := NewBaseMigration([]byte(yamlContent))
...
func TestBaseMigration_AttributeRemovals(t *testing.T) {
	yamlContent := `
resource_type: test_resource
source_version: v4
target_version: v5
...
func TestBaseMigration_ConditionalRemovals(t *testing.T) {
	yamlContent := `
resource_type: test_resource
source_version: v4
target_version: v5
...
func TestBaseMigration_DefaultValues(t *testing.T) {
	yamlContent := `
resource_type: test_resource
source_version: v4
target_version: v5
...
func TestBaseMigration_BlocksToLists(t *testing.T) {
	yamlContent := `
resource_type: test_resource
source_version: v4
target_version: v5
...
func TestBaseMigration_StateMigration(t *testing.T) {
	yamlContent := `
resource_type: test_resource
source_version: v4
target_version: v5
...
func TestBaseMigration_ComplexYAML(t *testing.T) {
	yamlContent := `
