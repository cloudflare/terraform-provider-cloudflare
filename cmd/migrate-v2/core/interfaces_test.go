...
func TestMigrationTypeAlias(t *testing.T) {
	// Test that Migration is an alias for ResourceMigration
	var m Migration = &mockInterfaceMigration{
		resourceType:  "cloudflare_test",
		sourceVersion: "v4",
		targetVersion: "v5",
	}

	// Should be able to use Migration wherever ResourceMigration is expected
	var rm ResourceMigration = m
