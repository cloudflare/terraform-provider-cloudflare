...
//     uri = "https://app2.com"
//   }
func ListToBlocksConverter(attrName string) common.TransformerFunc {
...
//   }
func ListToBlocksWithMapping(attrName string, fieldMapping map[string]string) common.TransformerFunc {
	return func(block *hclwrite.Block, ctx *common.TransformContext) error {
		if attrName == "" {
			return nil
		}
