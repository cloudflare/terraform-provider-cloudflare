...
//   addr_state = "CA"
//   addr_zip = "94102"
func SplitObjectTransformer(source string, attributes []string, prefix string) basic.TransformerFunc {
...
//   service_port = 443
//   protocol = "https"
func SplitObjectWithMapping(source string, attributeMap map[string]string) basic.TransformerFunc {
	return func(block *hclwrite.Block, ctx *basic.TransformContext) error {
		if source == "" {
			return nil
		}
