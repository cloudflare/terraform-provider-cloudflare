...
func ConditionalAttributeRemoverWithDefault(targetAttr string, conditionAttr string, allowedValues []string, defaultValue string, addDiagnostic bool) basic.TransformerFunc {
	return func(block *hclwrite.Block, ctx *basic.TransformContext) error {
		body := block.Body()
