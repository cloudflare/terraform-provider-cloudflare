...
//     zip = "94102"
//   }
func MergeAttributesTransformer(target string, sourceAttrs []string, format string) common.TransformerFunc {
...
//     proto = "https"
//   }
func MergeAttributesWithMapping(target string, attributeMap map[string]string) common.TransformerFunc {
	return func(block *hclwrite.Block, ctx *common.TransformContext) error {
		if target == "" {
			return nil
		}
...
//     state = "CA"
//   }
func MergePrefixedAttributes(target string, prefix string, stripPrefix bool) common.TransformerFunc {
	return func(block *hclwrite.Block, ctx *common.TransformContext) error {
